...
menu_but2: KeyboardButton = KeyboardButton(text=MENU_USER_LEXICON['status_but'])
menu_but3: KeyboardButton = KeyboardButton(text=MENU_USER_LEXICON['join_but'])
menu_but4: KeyboardButton = KeyboardButton(text=MENU_USER_LEXICON['dues_but'])
